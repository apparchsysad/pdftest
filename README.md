...
The circumstances that led to the devlopment of this code are described at [Searching PDF files - GCSE and "local-code" options](https://dev.to/mjoycemilburn/searching-pdf-files-coding-a-goggle-custom-search-engine-
gcse-component-in-react-36fk)