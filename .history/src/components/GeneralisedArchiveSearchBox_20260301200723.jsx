...
// The downloaded texts json file is stored in a useRef so that it survives between search renders. The
// searchbox is created in a module so that only users who click the "search" button will actually go looking
// for the file. As explained below,the file should be available from browser cache.
