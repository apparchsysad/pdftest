# When run with a SourceFolder=newsletters parameter, this script generates, for every newsletter pdf in Cloud
# storage, a corresponding entry in public/search_jsons/newsletters.json. Once deployed, this json can be used to
# deliver an extremely fast in-core text search facility in Newsletters.jsx
...
# The next stage uses the pdftotext utility to create a text version of each newsletter pdf
...
# with the ocrmypdf utility. This extracts text from graphic content and creates a "proper" pdf 
